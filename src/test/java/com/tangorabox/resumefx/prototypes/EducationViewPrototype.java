...
public class EducationViewPrototype extends ResumeApplicationPrototype {
    ...
    protected Parent createComponent(ResumeViewModel resumeViewModel) {
        return sectionPaneFactory.create(Section.EDUCATION, resumeViewModel.getEducations());
    }
}
