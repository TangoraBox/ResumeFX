...
public class VolunteerViewPrototype extends ResumeApplicationPrototype {
    ...
    protected Parent createComponent(ResumeViewModel resumeViewModel) {
        return sectionPaneFactory.create(Section.VOLUNTEER, resumeViewModel.getVolunteers());
    }
}
