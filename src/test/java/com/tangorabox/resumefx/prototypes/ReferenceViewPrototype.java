...
public class ReferenceViewPrototype extends ResumeApplicationPrototype {
    ...
    protected Parent createComponent(ResumeViewModel resumeViewModel) {
        return sectionPaneFactory.create(Section.REFERENCE, resumeViewModel.getReferences());
    }
}
